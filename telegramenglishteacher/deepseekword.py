    ...
    def generate_analy_content(self, content):
        ...
        message = {
            ...
            "content": (
                ...
                "ensuring all key phrases and words are appropriately compared. **Only include words or phrases that have been changed**. "
                "If there is no change in the word or phrase, do not include it in the comparison.\n\n"
                ...
                "- **Only include words or phrases that have been modified**. Do not include words or phrases that are unchanged.\n"
